#!/bin/bash 
#SBATCH --job-name=KUTPostFmriprep
#SBATCH -o ./logs/KUTPostFmriprep-%j.out
#SBATCH -p short
#SBATCH --constraint="skl-compat"
#SBATCH --cpus-per-task=1
#SBATCH --array 1-220:1
...
export MRIS=/gpfs3/well/margulies/projects/data/SRPBS_1600/KUT
SUBJECT_LIST=/gpfs3/well/margulies/projects/data/SRPBS_1600/KUT/SRPBS_1600_KUT_subjects.txt
...
if [ -e ${MRIS}/derivatives/fmriprep/sub-${sub}/func/sub-${sub}_task-rest_space-MNI152NLin2009cAsym_res-2_desc-preproc_bold.nii.gz ]; then
    ...
    python -u post_fmriprep_preproc_SRPBS_1600_KUT.py $sub
else
